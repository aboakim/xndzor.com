  ...
  await prisma.catalogListing.createMany({
    data: [
      ...
      },
      {
        category: "NATURAL_PRODUCT",
        subtype: "MILK",
        title: "Թարմ գյուղական կաթ · 1 լ",
        description:
          "Առավոտյան մթերված թարմ կովի կաթ։ Առանց հավելումների։ Կարող եք վերցնել գյուղից կամ առաքել մոտակա մարզեր։",
        brand: null,
        specsJson: JSON.stringify({ origin: "Ararat", organic: true, homemade: true }),
        quantity: 100,
        unit: "liter",
        packageSize: "1 L",
        priceAmd: 500,
      ...
      },
      {
        category: "NATURAL_PRODUCT",
        subtype: "CHEESE",
        title: "Լոռի պանիր · տնային · 1 կգ",
        description: "Գյուղում պատրաստված լոռի պանիր։ Թարմ և հասունացած տարբերակներ։",
        brand: null,
        specsJson: JSON.stringify({ origin: "Lori", organic: false, homemade: true }),
        quantity: 35,
        unit: "kg",
        packageSize: "1 kg",
        priceAmd: 3_800,
      ...
      },
      {
        category: "NATURAL_PRODUCT",
        subtype: "MATZOON",
        title: "Տնային մածուն · 1 լ",
        description: "Հաստ, թթվաշ գյուղական մածուն՝ առանց շաքարի։ Պատրաստվում է ամեն օր։",
        brand: null,
        specsJson: JSON.stringify({ origin: "Gegharkunik", organic: true, homemade: true }),
        quantity: 70,
        unit: "liter",
      ...
      },
      {
        category: "NATURAL_PRODUCT",
        subtype: "BUTTER",
        title: "Գյուղական կարագ · 500 գ",
        description: "Տնային կարագ՝ թարմ կաթից։ Առանց արհեստական հավելումների։",
        brand: null,
        specsJson: JSON.stringify({ origin: "Armavir", organic: false, homemade: true }),
        quantity: 25,
        unit: "kg",
