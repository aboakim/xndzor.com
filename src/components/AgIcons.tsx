...
const PRODUCT_ICONS: Record<string, (p: IconProps) => ReactElement> = {
  // Core + vegetables
  tomato: IconTomato,
  "cherry-tomato": IconTomato,
  potato: IconPotato,
  "sweet-potato": IconPotato,
  cucumber: IconCucumber,
  "cucumber-gherkin": IconCucumber,
  zucchini: IconCucumber,
  squash: IconCucumber,
  pumpkin: IconPotato,
  pattypan: IconCucumber,
  onion: IconOnion,
  shallot: IconOnion,
  leek: IconOnion,
  garlic: IconOnion,
  pepper: IconTomato,
  "bell-pepper": IconTomato,
  "hot-pepper": IconTomato,
  paprika: IconTomato,
  eggplant: IconCucumber,
  cabbage: IconOnion,
  "red-cabbage": IconOnion,
  cauliflower: IconOnion,
  broccoli: IconHay,
  kohlrabi: IconOnion,
  "brussels-sprouts": IconOnion,
  "chinese-cabbage": IconOnion,
  carrot: IconPotato,
  beet: IconPotato,
  "fodder-beet": IconPotato,
  radish: IconPotato,
  daikon: IconPotato,
  turnip: IconPotato,
  horseradish: IconOnion,
  celery: IconHay,
  spinach: IconHay,
  lettuce: IconHay,
  "swiss-chard": IconHay,
  ...
  asparagus: IconHay,
  artichoke: IconOnion,
  "jerusalem-artichoke": IconPotato,
  rhubarb: IconHay,
  "fennel-bulb": IconOnion,
  beans: IconPotato,
  "green-beans": IconPotato,
  peas: IconPotato,
  chickpeas: IconPotato,
  lentils: IconPotato,
  okra: IconCucumber,
  // Fruits
  grape: IconGrape,
  ...
  plum: IconApricot,
  cherry: IconApple,
  "sweet-cherry": IconApple,
  pear: IconApple,
  pomegranate: IconGrape,
  quince: IconApple,
  fig: IconApricot,
  persimmon: IconApricot,
  mulberry: IconApple,
  watermelon: IconGrape,
  melon: IconGrape,
  dogwood: IconApple,
  medlar: IconApple,
  loquat: IconApricot,
  ...
  lemon: IconApricot,
  orange: IconApricot,
  tangerine: IconApricot,
  grapefruit: IconApricot,
  kiwi: IconGrape,
  feijoa: IconGrape,
  avocado: IconPeach,
  berry: IconApple,
  ...
  raspberry: IconApple,
  blackberry: IconApple,
  blueberry: IconApple,
  blackcurrant: IconGrape,
  redcurrant: IconGrape,
  gooseberry: IconGrape,
  "sea-buckthorn": IconGrape,
  rosehip: IconApple,
  barberry: IconGrape,
  elderberry: IconGrape,
  cranberry: IconApple,
  // Nuts
  walnut: IconGrape,
  almond: IconGrape,
  ...
  vetch: IconHay,
  "sudan-grass": IconHay,
  "maize-silage": IconHay,
  "pasture-grass": IconHay,
  "compound-feed": IconHay,
  // Herbs
  dill: IconHay,
  parsley: IconHay,
  cilantro: IconHay,
  ...
  tan: IconMilk,
  "sour-cream": IconMilk,
  "cottage-cheese": IconMilk,
  cream: IconMilk,
  "lori-cheese": IconMilk,
  chanakh: IconMilk,
  chechil: IconMilk,
  "goat-milk": IconMilk,
  "sheep-milk": IconMilk,
  ...
  // Honey / preserves
  honey: IconHoney,
  "flower-honey": IconHoney,
  "mountain-honey": IconHoney,
  jam: IconHoney,
  compote: IconHoney,
  "fruit-leather": IconApricot,
  syrup: IconHoney,
  pickles: IconCucumber,
  "tomato-paste": IconTomato,
  beeswax: IconHoney,
  propolis: IconHoney,
  "royal-jelly": IconHoney,
  "bee-pollen": IconHoney,
  // Dried
  "dried-apricot": IconApricot,
  "dried-peach": IconPeach,
  "dried-plum": IconApricot,
  raisins: IconGrape,
  "dried-fig": IconApricot,
  "dried-apple": IconApple,
  "dried-mulberry": IconApple,
  "dried-persimmon": IconApricot,
  "dried-herbs": IconHay,
  "sun-dried-tomato": IconTomato,
  // Mushrooms / wine / seedlings / flowers / other
  champignon: IconOther,
  "oyster-mushroom": IconOther,
  "wild-mushroom": IconOther,
  porcini: IconOther,
  morel: IconOther,
  wine: IconGrape,
  "grape-must": IconGrape,
  "grape-juice": IconGrape,
  vinegar: IconGrape,
  "grape-leaves": IconGrape,
  "grape-seed-oil": IconOil,
  oghee: IconGrape,
  areni: IconGrape,
  "fruit-saplings": IconApple,
  "grape-cuttings": IconGrape,
  "vegetable-seedlings": IconCucumber,
  "flower-seedlings": IconHay,
  "tree-saplings": IconApple,
  "berry-plants": IconApple,
  "seeds-pack": IconSow,
  rose: IconOther,
  tulip: IconOther,
  gladiolus: IconOther,
  "cut-flowers": IconOther,
  "ornamental-plants": IconHay,
  chrysanthemum: IconOther,
  wool: IconOther,
  manure: IconHay,
  firewood: IconOther,
  charcoal: IconOther,
  "sunflower-oil": IconOil,
  "walnut-oil": IconOil,
  other: IconOther,
};
